...
export default function ProductDetail() {
    ...
    const [scale, setScale] = useState(1); // Default scale is 1 (no zoom)
    ...
    const handleMouseMove = (e) => {
        ...
        setOriginX(x);
        setOriginY(y);
        setScale(2); // Example scale factor
    };
    ...
    const fetchComment = () => {
        ...
        const productId = id
        fetch(`http://localhost:3005/api/comment/product/${productId}`)
            .then(response => {
                // 檢查 HTTP 響應是否成功
                if (!response.ok) {
    ...
    if (productDetail) {
        ...
        const handleAddToCart = () => {
            ...
            const requestData = {
                ...
                img: productData.image_url,  // 使用更新后的图片 URL
            };
        ...
        const handleSelectChange = (e) => {
            ...
            updatePhoto(newColor);
        };

        //顏色對應圖片
        const updatePhoto = (color) => {
            let newPhotoUrl = productData.image_url; // 預設圖片
            switch (color) {
                case '紅':
                    newPhotoUrl = productData.red;
                    break;
                case '綠':
                    newPhotoUrl = productData.green;
                    break;
                case '藍':
                    newPhotoUrl = productData.blue;
                    break;
                case '黃':
                    newPhotoUrl = productData.yellow;
                    break;
                default:
                    newPhotoUrl = productData.image_url; // 使用熱門色或預設圖片
            }
                ...
                <div className="container ">
                    ...
                    <div className="row">
                        <div className={`col-12 col-sm-6 left1  ${styles.left1}`}>
                            <div className={`zoom-container bigpic ${styles.bigpic}`} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} style={{ overflow: 'hidden' }}>
                                <figcaption className={`avatar1 ${styles.avatar1}`}>
                                    ...
                                    <img
                                        ...
                                        alt="Zoomed Product"
                                        ref={imageRef}
                                        style={{ width: '100%', transition: 'transform 0.1s ease', transform: `scale(${scale})`, transformOrigin: `${originX}% ${originY}%` }}
                            ...
                            <div className={`ppic2  ${styles.ppic2}`}>
                                ...
                                {/* <div className={`pic  ${styles.pic}`}>
                                    ...
                                    <figcaption className={`avatar2 ${styles.avatar2}`}>
                                        <img src={`/images/product/${productData.image_url}`} alt="" onClick={() => {
                                            handleColorClick('熱門色');
                                            setSelectedPhoto(productData.image_url);
                                        }} />
                                    </figcaption>
                                ...
                                <div className={`pic  ${styles.pic}`}>
                                    <figcaption className={`avatar2 ${styles.avatar2}`}>
                                        <img src={`/images/product/${productData.red}`} alt="" onClick={() => {
                                            handleColorClick('紅');
                                            setSelectedPhoto(productData.red);
                                        }} />
                                    </figcaption>
                                ...
                                <div className={`pic  ${styles.pic}`}>
                                    <figcaption className={`avatar2 ${styles.avatar2}`}>
                                        <img src={`/images/product/${productData.green}`} alt="" onClick={() => {
                                            handleColorClick('綠');
                                            setSelectedPhoto(productData.green);
                                        }} />
                                    </figcaption>
                                ...
                                <div className={`pic  ${styles.pic}`}>
                                    <figcaption className={`avatar2 ${styles.avatar2}`}>
                                        <img src={`/images/product/${productData.blue}`} alt="" onClick={() => {
                                            handleColorClick('藍');
                                            setSelectedPhoto(productData.blue);
                                        }} />
                                    </figcaption>
                                ...
                                <div className={`pic  ${styles.pic}`}>
                                    <figcaption className={`avatar2 ${styles.avatar2}`}>
                                        <img src={`/images/product/${productData.yellow}`} alt="" onClick={() => {
                                            handleColorClick('黃');
                                            setSelectedPhoto(productData.yellow);
                                        }} />
                                    </figcaption>
                        ...
                        <div className={`col-12 col-sm-6  right1 sss  ${styles.right1}  `}>
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className={`row  mt-3 mx-1 rounded-0 colorr  `} >
                                    <h6>顏色</h6>
                                    <label htmlFor="color-select"></label>
                                    <select className="form-select  rounded-0 mt-2" name="color" id="color-select" value={selectedColor} onChange={handleSelectChange}>
                        ...
                        <div className={`col-12 col-sm-6  left1  ${styles.left1}`}>
                            ...
                            {comment.length === 0 ? (
                                ...
                                comment.slice(0, 2).map(comment => (
                                    <div key={comment.id} className={`card rounded-0 shadow  ${styles.card}`}>
                                        <div className="card-body">
                                            <div className={`qqq ${styles.qqq}`}>
                                                <div className={`peo ${styles.peo}`}>
                                                    <img src={comment.photo &&
                                                            ...
                                                            ? `${comment.photo}`
                                                            : `http://localhost:3005/uploads/${comment.photo}`} alt="" />
                                                </div>
                                                <div className={`nam ${styles.nam}`}>
                                                    <h6 className="card-title">{comment.account === null
                                            ...
                                            <p className={`card-text ${styles.cardText}`}>{comment.description}</p>
                                        </div>
                                    </div>
                                )
                                ))}
                                    ...
                                    return (
                                        <Link key={product.id} href={`/product/${product.id}`}>
                                            ...
                                            <div className={`box7  ${styles.box7}`}>
                                                ...
                                                <h6 className={`box8 me-2 ${styles.box8}`}>${Math.round(product.price * 0.8)}</h6>
