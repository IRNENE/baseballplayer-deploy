...
export default function Product() {
    ...
    const debouncedFilterOptions = useDebounce(filterOptions, 650);  // 500毫秒的防抖延时
    ...
    useEffect(() => {
        fetchURL();
    }, [filterOptions, formData, sortOption, debouncedFilterOptions]);
    ...
    const fetchURL = async () => {
        ...
        Object.keys(filterOptions).forEach(key => {
            if (debouncedFilterOptions[key]) {
                queryParams.push(`${key}=${debouncedFilterOptions[key]}`);
            }
        });
    ...
    const [classifType2, setClassifType2] = useState(' 全部');
                ...
                <div className="row">
                    <div className="col-2 mt-5">
                        <div className={`breadcrumb1 ${styles.breadcrumb1}`}>
                            ...
                            <a href="/product" className={`tete ${styles.tete}`}>{classifType2}</a>
                            <span />
                        ...
                        <form action="">
                            ...
                            <div className={`div form-item  ${styles.div}`} >
                                <div className={`div-2 mt-3 mb-3  ${styles.div2}`} type="submit" onClick={handleClear2}><MdDelete style={{ verticalAlign: 'middle', fontSize: '1.15rem', color: 'red', marginRight: '5px' }} />清除篩選</div>
                    ...
                    <div className="col-12 col-sm-10 mt-5">
                        ...
                        <div className={`boxbox3  ${styles.boxbox3}`}>
                            <div className={`child light  ${styles.child} ${styles.light}`} data-bs-toggle="modal" data-bs-target="#exampleModal">
                            ...
                            <div className={`child light  ${styles.child}  ${styles.light}`} data-bs-toggle="modal" data-bs-target="#exampleModal1">
                            ...
                            <div className={`child  ${styles.child}`}  data-bs-toggle="modal" data-bs-target="#exampleModal2">
                                            ...
                                            <Link href={`/product/${product.id}`}>
                                                <figcaption className={`avatar ${styles.avatar}`}>
                                                    ...
                                                    <div className={styles.magnify}>
                                                        <img src="/images/product/magnify.png" />
                                                    </div>
                                                </figcaption>
                                ...
                                shouldShowPagination && (
                                    <nav aria-label="Page navigation example d-flex justify-content-center">
                                        <ul className="mt-5 pagination d-flex justify-content-center">
                                            ...
                                            >
                                                <a
                                                    ...
                                                    onClick={(event) => {
                                                        ...
                                                        window.scrollTo({ top: 500, behavior: 'smooth' }); // 滚动到页面顶部
                                                    }}
                                                >
                                            ...
                                            {/* 下一頁按鈕 */}
                                            <li
                                                className={`page-item pb-1 ps-2 ${currentPage === totalPages ? 'disabled' : ''
                                                    }`}
                                            >
                                                <a
                                                    className="page-link rounded-0"
