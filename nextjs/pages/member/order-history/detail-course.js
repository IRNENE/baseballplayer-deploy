                    ...
                    <div className="col-12 col-sm-9 py-2">
                        <div className={`${styles.titNub} d-flex align-items-center mb-4`}>
                            ...
                            <div className={`mx-3 px-1 py-1`}>
                                <h6><span className='badge bg-primary'>課程</span></h6>
                            </div>
                        </div>
                        ...
                        <div className={`row ${styles.tableWrapper}`} >
                            <table>
                                ...
                                <tbody className={`${styles.proTbody} align-items-center `}>
                                    <tr>
                                        <td>
                                            <div className={styles.infoCourseImg}>
                                                <img src="/images/course/23.jpg" alt="" />
                                            </div>
                                        </td>
                                        <td className={`${styles.describeTD} pt-4`} >
                                            <div className={styles.describe}>
                                                <span className={`${styles.bread} fw-bold `}><h6>投手養成訓練班</h6></span>
                                                <p className='mt-3'>
                                                    <span className=''>2024/03/01 17:00 ~ 18:00</span>
                                                </p>
                                                <p>
                                                    <span>教練 : 何献凡</span>
                                                </p>
                                        ...
                                        <td className="text-center">
                                            <p>
                                                <span className={`${styles.bread} fw-bold`}>$1800</span>
                                            </p>
                                    ...
                                    <tr>
                                        ...
                                        <td className={`${styles.describeTD} pt-4`} >
                                            <div className={styles.describe}>
                                                <span className={`${styles.bread} fw-bold`}><h6>投手養成訓練班</h6></span>
                                                <p className='mt-3'>
                                                    <span>2024/03/01 17:00 ~ 18:00</span>
                                                </p>
                                                <p>
                                                    <span>教練 : 何献凡</span>
                                                </p>
